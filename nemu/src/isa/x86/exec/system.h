...
static inline def_EHelper(mov_r2cr) {
  ...
  printf("movl %%%s,%%cr%d cr0 0x%08x cr3 0x%08x\n", reg_name(id_src1->reg, 4), id_dest->reg, cpu.cr0, cpu.cr3);
...
static inline def_EHelper(mov_cr2r) {
  ...
  printf("movl %%cr%d,%%%s cr0 0x%08x cr3 0x%08x\n", id_src1->reg, reg_name(id_dest->reg, 4), cpu.cr0, cpu.cr3);
